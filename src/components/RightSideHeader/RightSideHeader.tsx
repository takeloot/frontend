...
import {Button, Flex, ModalOverlay, Select, useDisclosure} from "@chakra-ui/react";
...
export const RightSideHeader: FC = () => {
  const BalanceOverlay = () => <ModalOverlay bg="blackAlpha.300" backdropFilter="blur(10px) hue-rotate(90deg)" />;
